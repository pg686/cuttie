    ...
    <div className="about">
      ...
      >
        <a href="https://x.com/thegallowboob/status/1441670584190992385">
          <img
            src="https://pg686.github.io/cuttie/images/tweeter.png"
            alt=""
            className="tweetImg"
          />
        </a>
      ...
      <motion.div
        ...
        variants={
          window.innerWidth <= 1100
            ? mobileButtonVariantRight
            : pcButtonVariantRight
        }
        initial="hidden"
        whileInView="visible"
        ...
        <div className="aboutSection">
          ...
          <div className="aboutInfo">
            ...
            <p className="thirdLine">
              ...
              Bruno Mars writes a new song. Not sure which is worse.
            </p>
            <div className="testimonials">
              <div className="testimonialWrapper">
                <div className="testimonial">
                  ...
                  />
                  "I once saw this dog punch a grizzly bear in the balls while
                  humping Megan Fox"
                </div>
                <div className="testimonialAuthor">- Andrew Tate</div>
              </div>
              <div className="testimonialWrapper">
                <div className="testimonial">
                  {" "}
                  <img
                    src="https://pg686.github.io/cuttie/images/grandma.jpg"
                    alt=""
                    className="testimonailImg"
                  />
                  "Send this shit!"
                </div>
                <div className="testimonialAuthor">- Grandma</div>
              </div>
            </div>
          </div>
        </div>
